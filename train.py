...
def train(train_config):
    ...
    if config["push_to_hub"]:
        ...
        model_wandb.add_file(
            "/content/pop909_gpt2_simple/pop909-epochs20/config.json"
        )
        model_wandb.add_file(
            "/content/pop909_gpt2_simple/pop909-epochs20/generation_config.json"
        )
        model_wandb.add_file(
            "/content/pop909_gpt2_simple/pop909-epochs20/pytorch_model.bin"
        )
        model_wandb.add_file(
            "/content/pop909_gpt2_simple/pop909-epochs20/special_tokens_map.json"
        )
        model_wandb.add_file(
            "/content/pop909_gpt2_simple/pop909-epochs20/tokenizer.json"
        )
        model_wandb.add_file(
            "/content/pop909_gpt2_simple/pop909-epochs20/tokenizer_config.json"
        )
        model_wandb.add_file(
            "/content/pop909_gpt2_simple/pop909-epochs20/training_args.bin"
        )
